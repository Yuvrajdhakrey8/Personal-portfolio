  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "yuvrajdhakrey8@gmail.com",
      link: "mailto:yuvrajdhakrey8@gmail.com",
    },
    {
      icon: <Phone className="w-5 h-5" />,
      label: "Phone",
      value: "(+91) 83202-60497",
      link: "tel:+918320260497",
    },
  ...
  const socialLinks = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/Yuvrajdhakrey8",
    },
    {
    ...
    },
    {
      ...
      label: "WhatsApp",
      link: "https://wa.me/+918320260497",
    },
  ];

  return (
    <section id="contact" className="min-h-screen pt-16 sm:pt-20 px-4 max-w-6xl mx-auto pb-16 sm:pb-20">
      <motion.div
