...
const searchData = [
  {
    ...
    path: '/',
    keywords: ['home', 'cv', 'resume', 'start', 'welcome', 'portfolio', 'yuvraj', 'yuvraj dhakrey', 'yuvraj1', 'software developer', 'full stack developer', 'mern stack', 'web developer'],
  },
  {
    title: 'About',
    description: 'Learn more about me and my background',
    path: '/about',
    keywords: ['about', 'background', 'education', 'bio', 'profile', 'cv', 'resume', 'yuvraj', 'dhakrey', 'full stack developer', 'software engineer', 'web developer'],
  },
  {
    title: 'Education',
    description: 'View my educational background',
    path: '/education',
    keywords: ['education', 'university', 'college', 'degree', 'school', 'board', 'computer science', 'engineering', 'b.e', 'electronics', 'government college'],
  },
  {
    title: 'Experience',
