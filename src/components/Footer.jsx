      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Full Stack Developer based in Surat, Gujarat, India.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:yuvrajdhakrey8@gmail.com"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Email Yuvraj Dhakrey"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  yuvrajdhakrey8@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+918320260497"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Yuvraj Dhakrey"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/Yuvrajdhakrey8"
                target="_blank"
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Yuvraj Dhakrey. All rights reserved.
            </p>
